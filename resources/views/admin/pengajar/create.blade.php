      ...
      <div class="relative flex justify-center overflow-hidden rounded-xl">
        <div class="divide-y divide-white/5">
          <div class="grid grid-cols-1 px-4 py-16 max-w-7xl gap-x-8 gap-y-10 sm:px-6 md:grid-cols-3 lg:px-8">
            ...
            <form class="md:col-span-2" method="POST" action="{{ route('admin.pengajar.store') }}" enctype="multipart/form-data">
              @csrf
              <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    <input id="nama_lengkap" name="nama_lengkap" type="text" class="block w-full rounded-md border-0 bg-white/5 py-1.5 px-2.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                  </div>
                  @error('nama_lengkap')
                    <div class="mt-2">
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    <input id="email" name="email" type="text" class="block w-full rounded-md border-0 bg-white/5 py-1.5 px-2.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                  </div>
                  @error('email')
                    <div class="mt-2">
                      <p class="ml-2 text-red-500 text-sm font-light">{{ $message }}</p>
                ...
                <div class="col-span-full">
                  ...
                  <div class="mt-2">
                    <input id="telepon" name="telepon" type="text" class="block w-full rounded-md border-0 bg-white/5 py-1.5 px-2.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                  </div>
                  @error('telepon')
                    <div class="mt-2">
                      <p class="ml-2 text-red-500 text-sm font-light">{{ $message }}</p>
