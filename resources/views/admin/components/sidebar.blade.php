      ...
      <ul role="list" class="flex flex-col flex-1 gap-y-7">
        <li>
          <ul role="list" class="-mx-2 space-y-1">
            <li>
              <a href="{{ route('admin') }}" class="flex p-2 text-sm font-semibold leading-6 {{ request()->routeIs('admin') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-800 text-white&quot;, Default: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
            ...
            <li>
              <a href="{{ route('admin.praktik.index') }}" class="flex p-2 text-sm font-semibold leading-6
            {{ request()->is('admin/praktik*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}
            rounded-md group gap-x-3" x-state-description="undefined: &quot;bg-gray-800 text-white&quot;, undefined: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
            ...
            <li>
              <a href="{{ route('admin.kelas.index') }}" class="flex p-2 text-sm font-semibold leading-6
            {{ request()->is('admin/kelas*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}
            rounded-md group gap-x-3" x-state-description="undefined: &quot;bg-gray-800 text-white&quot;, undefined: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
            ...
            <li>
              <a href="{{ route('admin.jadwal.index') }}" class="flex p-2 text-sm font-semibold leading-6
            {{ request()->is('admin/jadwal*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}
            rounded-md group gap-x-3" x-state-description="undefined: &quot;bg-gray-800 text-white&quot;, undefined: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
        ...
        <li>
          ...
          <ul role="list" class="mt-2 -mx-2 space-y-1">
            <li>
              <a href="{{ route('admin.siswa.index') }}" class="flex p-2 text-sm font-semibold leading-6
            {{ request()->is('admin/siswa*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}
            rounded-md group gap-x-3" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-800 text-white&quot;, Default: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
...
{{--            <li>--}}
{{--              <a href="{{ route('admin.nilai.index') }}" class="flex p-2 text-sm font-semibold leading-6--}}
{{--            {{ request()->is('admin/nilai*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}--}}
{{--            rounded-md group gap-x-3" x-state-description="undefined: &quot;bg-gray-800 text-white&quot;, undefined: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">--}}
...
{{--            </li>--}}
        ...
        <li>
          ...
          <ul role="list" class="mt-2 -mx-2 space-y-1 ">
            <li>
              <a href="{{ route('admin.pengajar.index') }}" class="flex p-2 text-sm font-semibold leading-6
            {{ request()->is('admin/pengajar*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}
            rounded-md group gap-x-3" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-800 text-white&quot;, Default: &quot;text-gray-400 hover:text-white hover:bg-gray-800&quot;">
