  ...
  <div class="flex flex-col px-6 overflow-y-auto bg-gray-900 grow gap-y-5">
    ...
    <nav class="flex flex-col flex-1">
      <ul role="list" class="flex flex-col flex-1 gap-y-7">
        ...
        <li>
          <a href="{{ route('siswa') }}" class="flex p-2 text-sm font-semibold leading-6 {{ request()->is('siswa/jadwal*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3">
        ...
        <li>
          <a href="{{ route('siswa.nilai.index') }}" class="flex p-2 text-sm font-semibold leading-6 {{ request()->is('siswa/nilai*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3">
