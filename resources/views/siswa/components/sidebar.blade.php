...
<<<<<<< HEAD
        ...
        <li>
          <a href="" class="flex p-2 text-sm font-semibold leading-6 {{ request()->is('admin/jadwal*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3">
...
=======
        <div class="text-xs font-semibold leading-6 text-gray-400">Siswa</div>
        <li>
          <a href="" class="flex p-2 text-sm font-semibold leading-6 {{ request()->is('siswa/jadwal*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3">
>>>>>>> b6955914344b9fc774f56dd72f4dae8605bda43e
        ...
        <li>
          <a href="" class="flex p-2 text-sm font-semibold leading-6 {{ request()->is('siswa/nilai*') ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-md group gap-x-3">
...
>>>>>>> b6955914344b9fc774f56dd72f4dae8605bda43e
        ...
        <li class="mt-auto -mx-6">
          <a href="{{ route('siswa.profile.index') }}" class="flex items-center px-6 py-3 text-sm font-semibold leading-6 text-white gap-x-4 hover:bg-gray-800">
