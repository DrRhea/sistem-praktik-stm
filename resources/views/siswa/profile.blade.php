            ...
            <form class="md:col-span-2" action="{{ route('admin.profile.update', ['id' => Auth::user()->id]) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                <div class="flex items-center col-span-full gap-x-8">
                  <img src="{{ $siswa->user->foto_profile ? asset('img/photo_profile/' . $siswa->user->foto_profile) : asset('img/photo_profile/default.png') }}" alt="" class="flex-none object-cover w-24 h-24 bg-gray-800 rounded-lg">
                  <div>
