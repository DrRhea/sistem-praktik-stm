    ...
    <div class="flex flex-1 min-h-full">
      <div class="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div class="w-full max-w-sm mx-auto lg:w-96">
          <div>
            <img class="w-auto h-10" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&amp;shade=600" alt="Perusahaan Anda">
            <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-white">Sistem Jadwal Kegiatan Praktek STM</h2>
            <p class="mt-2 text-sm leading-6 text-gray-400">
              Belum Punya Akun?
              <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300">Daftar Akun</a>
            </p>
          </div>
            ...
            <div>
              <form action="#" method="POST" class="space-y-6">
                <div>
                  ...
                  <div class="mt-2">
                    <input id="email" name="email" type="email" autocomplete="email" required class="block w-full rounded-md border-0 bg-white/10 py-1.5 shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="mt-2">
                    <input id="password" name="password" type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 bg-white/10 py-1.5 shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                  </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    ...
                    <label for="remember-me" class="block ml-3 text-sm leading-6 text-gray-400">Ingat Saya</label>
                  </div>
  
                  <div class="text-sm leading-6">
                    <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300">Lupa kata sandi?</a>
                  </div>
                </div>
            ...
            <div class="mt-10">
              <div class="relative">
                ...
                <div class="relative flex justify-center text-sm font-medium leading-6">
                  <span class="px-6 text-white bg-gray-900">Atau lanjutkan dengan</span>
                </div>
              </div>
